...
PanelWindow {
    ...
    Item {
        ...
        Component.onCompleted: {
            let startMode = Quickshell.env("QS_NETWORK_MODE");
            if (startMode === "wifi" || startMode === "bt") {
                activeMode = startMode;
            }

            Quickshell.execDetached(["bash", "-c", "echo '" + activeMode + "' > /tmp/qs_network_mode"]);
        ...
        readonly property string scriptsDir: Quickshell.env("HOME") + "/dotfiles/.config/quickshell/network"
