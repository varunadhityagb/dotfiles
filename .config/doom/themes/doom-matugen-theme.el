...
(def-doom-theme doom-matugen
  ...
  ((bg         '("#101418" "black"       "black"  ))
   ...
   (fg-alt     '("#8c9198" "#2d2d2d"     "white"        ))

   ;; Base spectrum from bg to fg
   (base0      '("#0b0f12" "black"       "black"        ))
   (base1      '("#181c20" "#1e1e1e"     "brightblack"  ))
   (base2      '("#1c2024" "#2e2e2e"     "brightblack"  ))
   (base3      '("#272a2e" "#262626"     "brightblack"  ))
   (base4      '("#42474e" "#3f3f3f"     "brightblack"  ))
   (base5      '("#8c9198" "#525252"     "brightblack"  ))
   (base6      '("#c2c7ce" "#6b6b6b"     "brightblack"  ))
   (base7      '("#363a3e" "#979797"     "brightblack"  ))
   (base8      '("#e0e2e8" "#dfdfdf"     "white"        ))

   (grey       base4)
   (red        '("#ffb4ab" "#ff6655" "red"          ))
   (orange     '("#d1bfe7" "#dd8844" "brightred"    ))
   (green      '("#b8c8da" "#99bb66" "green"        ))
   (teal       '("#98ccf9" "#44b9b1" "brightgreen"  ))
   (yellow     '("#ecdcff" "#ECBE7B" "yellow"       ))
   (blue       '("#98ccf9" "#51afef" "brightblue"   ))
   (dark-blue  '("#054b72" "#2257A0" "blue"         ))
   (magenta    '("#d1bfe7" "#c678dd" "brightmagenta"))
   (violet     '("#d1bfe7" "#a9a1e1" "magenta"      ))
   (cyan       '("#cce5ff" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#394857" "#5699AF" "cyan"         ))
