...
(def-doom-theme doom-matugen
  ...
  ;; name        default   256           16
  ((bg         '("#101417" "black"       "black"  ))
   (fg         '("#e0e3e8" "#bfbfbf"     "brightwhite"  ))

   ;; Off-color variants
   (bg-alt     '("#1c2024" "black"       "black"        ))
   (fg-alt     '("#8b9198" "#2d2d2d"     "white"        ))

   ;; Base spectrum from bg to fg
   (base0      '("#0b0f12" "black"       "black"        ))
   (base1      '("#181c20" "#1e1e1e"     "brightblack"  ))
   (base2      '("#1c2024" "#2e2e2e"     "brightblack"  ))
   (base3      '("#262a2e" "#262626"     "brightblack"  ))
   (base4      '("#41474d" "#3f3f3f"     "brightblack"  ))
   (base5      '("#8b9198" "#525252"     "brightblack"  ))
   (base6      '("#c1c7ce" "#6b6b6b"     "brightblack"  ))
   (base7      '("#363a3e" "#979797"     "brightblack"  ))
   (base8      '("#e0e3e8" "#dfdfdf"     "white"        ))

   (grey       base4)
   (red        '("#ffb4ab" "#ff6655" "red"          ))
   (orange     '("#cfc0e8" "#dd8844" "brightred"    ))
   (green      '("#b7c9d9" "#99bb66" "green"        ))
   (teal       '("#95cdf7" "#44b9b1" "brightgreen"  ))
   (yellow     '("#eaddff" "#ECBE7B" "yellow"       ))
   (blue       '("#95cdf7" "#51afef" "brightblue"   ))
   (dark-blue  '("#004b6f" "#2257A0" "blue"         ))
   (magenta    '("#cfc0e8" "#c678dd" "brightmagenta"))
   (violet     '("#cfc0e8" "#a9a1e1" "magenta"      ))
   (cyan       '("#c9e6ff" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#384956" "#5699AF" "cyan"         ))
