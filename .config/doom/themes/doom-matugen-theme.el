...
(def-doom-theme doom-matugen
  ...
  ;; name        default   256           16
  ((bg         '("#0e1415" "black"       "black"  ))
   (fg         '("#dee4e4" "#bfbfbf"     "brightwhite"  ))

   ;; Off-color variants
   (bg-alt     '("#1b2122" "black"       "black"        ))
   (fg-alt     '("#899294" "#2d2d2d"     "white"        ))

   ;; Base spectrum from bg to fg
   (base0      '("#090f10" "black"       "black"        ))
   (base1      '("#171d1e" "#1e1e1e"     "brightblack"  ))
   (base2      '("#1b2122" "#2e2e2e"     "brightblack"  ))
   (base3      '("#252b2c" "#262626"     "brightblack"  ))
   (base4      '("#3f484a" "#3f3f3f"     "brightblack"  ))
   (base5      '("#899294" "#525252"     "brightblack"  ))
   (base6      '("#bec8ca" "#6b6b6b"     "brightblack"  ))
   (base7      '("#343a3b" "#979797"     "brightblack"  ))
   (base8      '("#dee4e4" "#dfdfdf"     "white"        ))

   (grey       base4)
   (red        '("#ffb4ab" "#ff6655" "red"          ))
   (orange     '("#b9c6ea" "#dd8844" "brightred"    ))
   (green      '("#b1cbcf" "#99bb66" "green"        ))
   (teal       '("#81d3df" "#44b9b1" "brightgreen"  ))
   (yellow     '("#d9e2ff" "#ECBE7B" "yellow"       ))
   (blue       '("#81d3df" "#51afef" "brightblue"   ))
   (dark-blue  '("#004f57" "#2257A0" "blue"         ))
   (magenta    '("#b9c6ea" "#c678dd" "brightmagenta"))
   (violet     '("#b9c6ea" "#a9a1e1" "magenta"      ))
   (cyan       '("#9df0fb" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#324b4e" "#5699AF" "cyan"         ))
