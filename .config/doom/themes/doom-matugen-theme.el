...
(def-doom-theme doom-matugen
  ...
  ;; name        default   256           16
  ((bg         '("#1a120d" "black"       "black"  ))
   (fg         '("#f0dfd7" "#bfbfbf"     "brightwhite"  ))

   ;; Off-color variants
   (bg-alt     '("#271e19" "black"       "black"        ))
   (fg-alt     '("#9f8d84" "#2d2d2d"     "white"        ))

   ;; Base spectrum from bg to fg
   (base0      '("#140c09" "black"       "black"        ))
   (base1      '("#221a15" "#1e1e1e"     "brightblack"  ))
   (base2      '("#271e19" "#2e2e2e"     "brightblack"  ))
   (base3      '("#322823" "#262626"     "brightblack"  ))
   (base4      '("#52443d" "#3f3f3f"     "brightblack"  ))
   (base5      '("#9f8d84" "#525252"     "brightblack"  ))
   (base6      '("#d7c2b9" "#6b6b6b"     "brightblack"  ))
   (base7      '("#413732" "#979797"     "brightblack"  ))
   (base8      '("#f0dfd7" "#dfdfdf"     "white"        ))

   (grey       base4)
   (red        '("#ffb4ab" "#ff6655" "red"          ))
   (orange     '("#cec991" "#dd8844" "brightred"    ))
   (green      '("#e6beab" "#99bb66" "green"        ))
   (teal       '("#ffb68f" "#44b9b1" "brightgreen"  ))
   (yellow     '("#eae5ab" "#ECBE7B" "yellow"       ))
   (blue       '("#ffb68f" "#51afef" "brightblue"   ))
   (dark-blue  '("#703714" "#2257A0" "blue"         ))
   (magenta    '("#cec991" "#c678dd" "brightmagenta"))
   (violet     '("#cec991" "#a9a1e1" "magenta"      ))
   (cyan       '("#ffdbca" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#5c4132" "#5699AF" "cyan"         ))
