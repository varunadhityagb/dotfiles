...
(def-doom-theme doom-matugen
  ...
  ;; name        default   256           16
  ((bg         '("#131318" "black"       "black"  ))
   (fg         '("#e5e1e9" "#bfbfbf"     "brightwhite"  ))

   ;; Off-color variants
   (bg-alt     '("#201f25" "black"       "black"        ))
   (fg-alt     '("#928f9a" "#2d2d2d"     "white"        ))

   ;; Base spectrum from bg to fg
   (base0      '("#0e0e13" "black"       "black"        ))
   (base1      '("#1b1b21" "#1e1e1e"     "brightblack"  ))
   (base2      '("#201f25" "#2e2e2e"     "brightblack"  ))
   (base3      '("#2a292f" "#262626"     "brightblack"  ))
   (base4      '("#47464f" "#3f3f3f"     "brightblack"  ))
   (base5      '("#928f9a" "#525252"     "brightblack"  ))
   (base6      '("#c8c5d0" "#6b6b6b"     "brightblack"  ))
   (base7      '("#39383f" "#979797"     "brightblack"  ))
   (base8      '("#e5e1e9" "#dfdfdf"     "white"        ))

   (grey       base4)
   (red        '("#ffb4ab" "#ff6655" "red"          ))
   (orange     '("#eab9d1" "#dd8844" "brightred"    ))
   (green      '("#c7c4dd" "#99bb66" "green"        ))
   (teal       '("#c3c0ff" "#44b9b1" "brightgreen"  ))
   (yellow     '("#ffd8ea" "#ECBE7B" "yellow"       ))
   (blue       '("#c3c0ff" "#51afef" "brightblue"   ))
   (dark-blue  '("#424078" "#2257A0" "blue"         ))
   (magenta    '("#eab9d1" "#c678dd" "brightmagenta"))
   (violet     '("#eab9d1" "#a9a1e1" "magenta"      ))
   (cyan       '("#e2dfff" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#464559" "#5699AF" "cyan"         ))
