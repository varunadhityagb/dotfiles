...
# Navigation
bind = , up,     exec, adb shell input keyevent 19   # D-Pad Up
bind = , down,   exec, adb shell input keyevent 20   # D-Pad Down
bind = , left,   exec, adb shell input keyevent 21   # D-Pad Left
bind = , right,  exec, adb shell input keyevent 22   # D-Pad Right
bind = , return, exec, adb shell input keyevent 23   # D-Pad Center (Select/OK)
bind = , escape, exec, adb shell input keyevent 4    # Back
bind = , H,      exec, adb shell input keyevent 3    # Home

# Playback
bind = , space,  exec, adb shell input keyevent 85   # Play/Pause
bind = , S,      exec, adb shell input keyevent 86   # Stop
bind = , period, exec, adb shell input keyevent 87   # Next
bind = , comma,  exec, adb shell input keyevent 88   # Previous
bind = , F,      exec, adb shell input keyevent 90   # Fast Forward
bind = , R,      exec, adb shell input keyevent 89   # Rewind
...
# Channels
bind = , prior,  exec, adb shell input keyevent 166  # Channel Up   (Page Up key)
bind = , next,   exec, adb shell input keyevent 167  # Channel Down (Page Down key)
