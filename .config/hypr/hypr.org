...
exec-once = matugen image /home/varunadhityagb/Downloads/desert.jpg
#+end_src
...
animations {
    ...
    # Windows
    animation = windowsIn,   1, 3,  smooth, popin 80
    animation = windowsOut,  1, 3,  smooth , popin 80
...
bindel=, XF86MonBrightnessDown, exec, brightnessctl s 5%- && ~/dotfiles/.config/hypr/scripts/brightness_notify 0
bindel=, XF86MonBrightnessUp, exec, brightnessctl s 5%+  && ~/dotfiles/.config/hypr/scripts/brightness_notify 0
